...
const NOTES: { icon: string; text: string }[] = [
  ...
  { icon: 'lock', text: '모든 기록은 이 기기에만 저장되고 서버로 보내지 않아요. 환자 이름을 그대로 입력해 쓸 수 있고, 밖으로 공유할 땐 자동으로 가려져요(홍*동) — 병동·약과 합치면 식별될 수 있으니 병원 공식 채널로만 공유하세요.' },
  { icon: 'shield', text: '환자 이름이 기기에 저장돼요. 업무폰 화면잠금을 켜고 분실에 주의하세요.' },
];
