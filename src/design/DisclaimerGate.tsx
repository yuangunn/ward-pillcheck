...
const NOTES: { icon: string; text: string }[] = [
  ...
  { icon: 'lock', text: '모든 기록은 이 기기에만 저장되고 서버로 보내지 않아요. 환자는 이름 대신 병상번호로 적기를 권장하며, 인계는 원내 Teams(병원 도메인)로만 보낼 수 있어요.' },
  { icon: 'shield', text: '입력한 라벨(병상번호·이름)이 기기에 저장돼요. 업무폰 화면잠금을 켜고 분실에 주의하세요.' },
];
